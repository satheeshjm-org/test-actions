...
async function construct_pr_body(staging_branch, production_branch, body_config) {
...
async function run() {
  ...
  try {
    ...
    var pr_body = construct_pr_body(staging_branch, production_branch, body_config)
